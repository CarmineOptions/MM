import tomli
from .cfg_classes import AccountConfig, AssetConfig, OrderChainElementConfig, ReconcilerConfig, StrategyConfig
...
def load_config(path: str) -> StrategyConfig:
    ...
    orderchain = [
        OrderChainElementConfig.from_dict(i)
        for i in raw['orderchain']
    ]
