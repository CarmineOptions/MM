...
async def setup_unlimited_approvals(account: Account, remus_contract, market_cfg, base_token_contract, quote_token_contract, nonce):
     ...
     logging.info(f"Set unlimited approval for base token: {hex(market_cfg[1]['base_token'])}")
     ...
     logging.info(f"Set unlimited approval for quote token: {hex(market_cfg[1]['quote_token'])}")
